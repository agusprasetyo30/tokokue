         ...
         <div class="col-md-6">
            <form action=""  method="post" enctype="multipart/form-data">
               <div class="form-group text-left">
                  ...
                  <input type="text" id="nama" name="nama" class="form-control" placeholder="Masukan Nama Makanan" readonly/>
               </div>
               ...
               <div class="form-group text-left">
                  <label for="harga" class="text-left">Harga</label>
                     <div class="input-group">
                           ...
                           <input type="number" id="harga" name="harga" class="form-control" placeholder="Masukan Harga" readonly/>
								</div>
                     </div>
               </div>
